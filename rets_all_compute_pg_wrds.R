...
msi <- tbl(db, Id(database = "pg", schema = "crsp", table = "msi"))
ccmxpf_lnkhist <- tbl(db, Id(database = "pg",
                             schema = "crsp", 
                             table = "ccmxpf_lnkhist"))
stocknames <- tbl(db, Id(database = "pg",
                         schema = "crsp", 
                         table = "stocknames"))

fundq <- tbl(db, Id(database = "pg",
                    schema = "comp", table = "fundq"))
annc_events <-
  fundq |>
